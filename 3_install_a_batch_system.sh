...
#HOSTALLOW\_READ = * HOSTALLOW\_WRITE = * HOSTALLOW\_ADMINISTRATOR = *
                                                                                          #Rememebr that the security Group must allow tcp for ports 0 - 65535 from the same security group, i.e.: All TCP TCP 0 - 65535 sg-008742ba0467986fe (aws_condor) Security group must allow ping
